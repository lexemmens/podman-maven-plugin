...
public class ImageConfigurationTest {
    ...
    public void testEmptyImageConfiguration() throws MojoExecutionException {
        ImageConfiguration ic = new ImageConfiguration(null, null, null, null, false);
    ...
    {
        ImageConfiguration ic = new ImageConfiguration(null, null, new String[]{"registry.example.org:1234/repo/tag"}, "0.0.1", false);
